...
VALUES
(N'Cà phê', 'img_coffee', 1, 0),
(N'Trà', 'img_tea', 1, 0),
(N'Thức uống đặc biệt', 'img_special_drink', 1, 0),
(N'Trà sữa', 'img_milk_tea', 1, 0),
(N'Topping', 'img_topping', 1, 0);
...
(1, N'Cà phê sữa', 30000, 'image_url_milk_coffee', N'Cà phê sữa đặc ngon ngọt', '2025-02-26 09:30:00', 1, 1, 0),
...
(1, N'Cappuccino', 45000, 'image_url_cappuccino', N'Cappuccino pha kiểu Ý', '2025-02-27 15:45:00', 1, 1, 0),
...
(3, N'Matcha latte', 48000, 'image_url_matcha_latte', N'Matcha latte thơm ngon', '2025-02-26 14:00:00', 1, 1, 0),
(3, N'Mocha', 50000, 'image_url_mocha', N'Cà phê mocha kết hợp chocolate', '2025-02-25 16:30:00', 1, 1, 0),

-- Trà sữa
(4, N'Trà sữa truyền thống', 30000, 'image_url_boba', N'Trà sữa đậm đà kết hợp trân châu đen dai ngon', '2025-02-26 08:00:00', 1, 1, 0),
...
(5, N'Kem sữa', 8000, 'image_url_cream', N'Lớp kem sữa béo ngậy', '2025-02-24 13:00:00', 1, 1, 0),
(5, N'Hạt chia', 6000, 'image_url_chia_seeds', N'Hạt chia bổ dưỡng', '2025-01-19 14:45:00', 1, 1, 0),
(5, N'Trân châu trắng', 5500, 'image_url_white_boba', N'Trân châu trắng giòn', '2025-01-27 15:30:00', 1, 1, 0);

INSERT INTO orders (userId, totalPrice, note, orderDate, deliveryAddress, deliveryPhone, status)
VALUES
(1, 175000, N'Khách hàng yêu cầu giao hàng nhanh', '2025-02-28 10:00:00', N'123 Đường A, Quận B, TP. HCM', '0909123456', N'Processing'),
(1, 225000, N'Không có yêu cầu đặc biệt', '2025-02-28 14:30:00', N'456 Đường C, Quận D, TP. HCM', '0909876543', N'Completed'),
(1, 95000, N'Yêu cầu giao buổi sáng', '2025-02-28 08:15:00', N'789 Đường E, Quận F, TP. HCM', '0909345678', N'Processing'),
(1, 300000, N'Khách hàng yêu cầu giao vào buổi chiều', '2025-02-28 16:45:00', N'111 Đường G, Quận H, TP. HCM', '0909567890', N'Completed'),
(1, 145000, N'Không có yêu cầu đặc biệt', '2025-02-28 12:00:00', N'222 Đường I, Quận J, TP. HCM', '0909765432', N'Cancelled');
